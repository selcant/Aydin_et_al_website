...
# protein data + mapping stuff
# expr.esc_prot, exprZ.esc_prot, all.prots, covar.esc_prot, covarTiday.esc_prot, probs.esc_prot, kinship.esc_prot, gmap, pmap


# rna, atac data (shared) and mapping stuff
# shared for MOFA
# 
