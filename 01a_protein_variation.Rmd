...
save( file = here("DO_mECS_proteomics.RData"),
      expr.esc_prot,
      exprZ.esc_prot, 
      all.prots,
      probs.esc_prot,
...
# 2.	pQTL data: DO_mESC_pQTL.RData file contains the following objects.
# •	do_mesc_pqtl_scans
# •	do_mesc_pqtl_prot_meds
# •	do_mesc_pqtl_rna_meds
# •	do_mesc_pqtl_perms
# need to load the scans and rename
...
do_mesc_pqtl_scans <- esc.prot.scans
rm(esc.prot.scans)
...
save(
  ...
  do_mesc_pqtl_rna_meds,
  do_mesc_pqtl_perms,
  file = here("DO_mESC_pQTL.RData")
)

# 3.	Data used in MOFA and integration results: DO_mESC_MOFA.RData
# •	all_df_shared
# •	all_df_shared_model
