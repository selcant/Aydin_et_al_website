...
factor4_lod_plot+
  geom_point( data = Figure5E_data_mediation, 
              aes( x = middle*1e06+chrom_lens_offset[10],
                   y = LOD),
              col = qtl.colors[["rna"]],
              size = 4,
              alpha = 0.9)+
  annotate( "label", 
            ...
            x =factor4_meds_min$middle*1e06+chrom_lens_offset[10]-1.9e08 ,
  ...
  annotate("label",
           y = factor4_meds_duxf$LOD+0.1, 
            x =factor4_meds_duxf$middle*1e06+chrom_lens_offset[10]-1.3e08 ,
